...
export declare enum OptionalMediaControl {
 ...
 * Presentation requirement of the disclosure.
 */
export declare enum PresentationRequirement {
 ...
 * Indicates a hint for the url type.
 */
export declare enum URLTypeHint {
 ...
 * Required: Type of action.
 */
export declare enum FollowUpActionType {
    Call = "CALL",
    Cancel = "CANCEL",
 ...
 * Required: Type of money attribute.
 */
export declare enum PriceAttributeType {
    Delivery = "DELIVERY",
    Discount = "DISCOUNT",
    Fee = "FEE",
    Gratuity = "GRATUITY",
 ...
 * what fulfillment type is chosen, corresponding details would be collected from the user.
 */
export declare enum CurbsideFulfillmentType {
    Unspecified = "UNSPECIFIED",
 ...
 * same payment method with both google and merchant.
 */
export declare enum PaymentMethodProvenance {
 ...
 * Location of the purchase (in-store / online)
 */
export declare enum PurchaseLocationType {
 ...
 * Type of the event character, e.g. actor or director.
 */
export declare enum EventCharacterType {
    Actor = "ACTOR",
    Director = "DIRECTOR",
    Organizer = "ORGANIZER",
    Performer = "PERFORMER",
 ...
 * Required: Type of the ticket event, e.g. movie, concert.
 */
export declare enum TicketEventType {
    Concert = "CONCERT",
